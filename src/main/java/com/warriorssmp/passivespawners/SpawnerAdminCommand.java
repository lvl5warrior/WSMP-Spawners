...
public class SpawnerAdminCommand implements CommandExecutor {
    ...
    public SpawnerAdminCommand(SpawnerManager manager, SpawnerItemFactory itemFactory) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "Usage: /wsmpadmin spawners give|list ...");
            return true;
        }
        ...
        return switch (args[1].toLowerCase(Locale.ROOT)) {
            ...
            default -> {
                sender.sendMessage(ChatColor.RED + "Unknown subcommand. Use 'give' or 'list'.");
                yield true;
            }
        };
    }
