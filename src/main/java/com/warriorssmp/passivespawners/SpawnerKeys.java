...
public class SpawnerKeys {
    ...
    public final NamespacedKey blockStoredItems;
    ...
    public SpawnerKeys(Plugin plugin) {
        ...
        blockStoredItems = new NamespacedKey(plugin, "spawner_stored_items");
        hologramMarker = new NamespacedKey(plugin, "spawner_hologram_marker");
